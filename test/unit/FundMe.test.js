...
!developmentChains.includes(network.name)
    ...
    : describe("FundMe", async function () {
          ...
          describe("constructor", async function () {
              it("Sets the aggregated address correctly!", async function () {
          ...
          describe("fund", async function () {
              ...
              it("Updated the amount funded data structure!", async function () {
                  ...
                  const response = await fundMe.getAddressToFundedValue(
                      deployer
                  )
                  assert.equal(response.toString(), sendValue.toString())
              })

              it("Added the funder address into an array!", async function () {
                  await fundMe.fund({ value: sendValue })
          ...
          describe("withdraw", async function () {
              ...
              it("Withdraw ETH from multiple getFunders!", async function () {
                  ...
                  for (let i = 0; i < 6; i++) {
                      assert.equal(
                          await fundMe.getAddressToFundedValue(
                              accounts[i].address
                          ),
                          0
                      )
              ...
              it("Only owner is allow to withdraw", async function () {
